...
module.exports = {
    ...
    const pjparty_embed = new Discord.MessageEmbed()
        .setTitle(' :tada: The Popsicle Joint turned 1! :tada: ')
        .setColor('#ff9f5c')
        .setDescription('Thanks for chilling with us :champagne_glass:  ')
        .setImage(pjparty_image)
        .setFooter({text: ' On behalf of the Girly Pops, we would like to thank everyone for making our first year together so wonderful. Cheers to another great year!  '})
